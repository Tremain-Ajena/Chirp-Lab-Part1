    ...
    return (
        <React.Fragment>
            ...
            <div className="card mb-3 text-white bg-secondary" style={{ maxWidth: '540px' }}>
                <div className="row no-gutters">
                    <div className="col-md-4">
                        <img src="https://img.huffingtonpost.com/asset/5b3a38212000004200b95ef9.jpeg?cache=s4vypl87zq&ops=scalefit_630_noupscale" className="card-img" alt="Steve" />
                    </div>
            ...
            <div className="card mb-3 text-white bg-secondary" style={{ maxWidth: '540px' }}>
                <div className="row no-gutters">
                    <div className="col-md-4">
                        <img src="https://m.media-amazon.com/images/M/MV5BZGQ2ZDc1MzYtNWRlNi00YjFjLTk4YTctZTNhYWExMzhhNzk1XkEyXkFqcGdeQXVyMTg2NjYzOA@@._V1_.jpg" className="card-img" alt="Static Shock" />
                    </div>
                    <div className="col-md-8">
                        <div className="card-header">
                            <h5 className="card-title">Card title</h5>
